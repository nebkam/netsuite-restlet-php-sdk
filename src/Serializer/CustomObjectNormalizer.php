...
class CustomObjectNormalizer extends AbstractNormalizer
	...
	public function normalize($object, $format = null, array $context = [])
		...
		foreach ($attributes as $attribute)
			...
			$data = $this->updateData($data, $attribute, $attributeValue, $class);
			}
		...
		foreach ($stack as $attribute => $attributeValue)
			...
			$data = $this->updateData($data, $attribute, $this->serializer->normalize($attributeValue, $format, $this->createChildContext($context, $attribute, $format)), $class);
			}
	 ...
	 * @return string[]
	 */
	protected function getAttributes($object, $format, $context)
		{
		$class = get_class($object);
	 ...
	 * @return string[]
	 */
	protected function extractAttributes($object, $format = null, $context = [])
		{
	 ...
	 * @return mixed
	 */
	protected function getAttributeValue($object, $attribute, $format = null, $context = [])
		{
	...
	public function denormalize($data, $type, $format = null, array $context = [])
		...
		foreach ($normalizedData as $attribute => $value)
			...
			if ($this->nameConverter)
				{
				$attribute = $this->nameConverter->denormalizeWithClass($attribute, $class);
				}

			if ((false !== $allowedAttributes && !in_array($attribute, $allowedAttributes, true)) || !$this->isAllowedAttribute($type, $attribute, $format, $context))
				{
	 ...
	 * @param array $context
	 * @param null $format
	 * @return array|array[]|float|mixed|object|null
	 * @internal
	 */
	 ...
	 * @return array
	 */
	private function updateData($data, $attribute, $attributeValue, $class)
		{
		if ($this->nameConverter)
			{
			$attribute = $this->nameConverter->normalizeWithClass($attribute, $class);
			}
